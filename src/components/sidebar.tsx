    ...
    return (
        <div className="flex w-64 flex-col border-r bg-sidebar h-screen">
            <div className="flex h-16 shrink-0 items-center border-b px-6">
                ...
                <span className="font-bold text-lg text-sidebar-foreground font-sidebar tracking-tight uppercase">OptiAsset</span>
            </div>
            <div className="flex flex-1 flex-col justify-between p-4">
                <nav className="flex flex-col gap-2">
                    {visibleNavItems.map((item) => (
                        <Link
                            ...
                            href={item.href}
                            className={cn(
                                "flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-semibold tracking-tight font-sidebar transition-colors",
                                pathname === item.href
                ...
                <div className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-semibold tracking-tight font-sidebar text-sidebar-foreground hover:bg-destructive/10 hover:text-destructive cursor-pointer transition-colors" onClick={logout}>
