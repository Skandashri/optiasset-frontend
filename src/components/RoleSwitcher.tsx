...
export function RoleSwitcher() {
    ...
    const handleRoleSwitch = async () => {
        ...
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://asset-management-system-1-cm2v.onrender.com'}/api/users/switch-role?target_role=${encodeURIComponent(secondaryRole)}`, {
                method: "POST",
                headers: {
